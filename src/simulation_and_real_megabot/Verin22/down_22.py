...
#     plt.scatter(masses, vitesses_moyennes, color='r', label='Vitesses moyennes')

#     # Utilisation de linregress pour obtenir la régression linéaire et les statistiques
#     slope, intercept, r_value, p_value, std_err = linregress(masses, vitesses_moyennes)

#     # Calcul des valeurs de la ligne de régression
#     regression_values = [slope * x + intercept for x in masses]
#     plt.plot(masses, regression_values, color='b', label='Régression linéaire')

#     plt.title("Vitesses en descente du verrin 2.2")
