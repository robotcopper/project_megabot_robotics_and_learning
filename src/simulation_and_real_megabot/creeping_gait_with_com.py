...
- Move one leg after the other following the creeping gait in the simulation
- Send all the joints values (in the simulation) to the Megabot microcontroller at each new target (interpolated or not)
